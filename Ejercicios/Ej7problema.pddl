(define (problem ejercicio7-problem)
...
(:INIT 
	...
	;TiposTerreno
		...
		(TipoTerreno z3 arena)
		(TipoTerreno z4 arena)
		(TipoTerreno z5 arena)
		(TipoTerreno z6 arena)
		(TipoTerreno z7 arena)
		(TipoTerreno z8 arena)
		(TipoTerreno z9 arena)
		(TipoTerreno z10 arena)
		(TipoTerreno z11 arena)
		(TipoTerreno z12 arena)
		(TipoTerreno z13 arena)
		(TipoTerreno z14 arena)
		(TipoTerreno z15 arena)
		(TipoTerreno z16 arena)
		(TipoTerreno z17 arena)
		(TipoTerreno z18 arena)
		(TipoTerreno z19 arena)
		(TipoTerreno z20 arena)
		(TipoTerreno z21 arena)
		(TipoTerreno z22 arena)
		(TipoTerreno z23 arena)
	...
	; Situaciones Inicialies
		...
		(SituadoEn principe z23)
		(SituadoEn bruja z24)
		(SituadoEn profesor z25)
		(SituadoEn manzana z1)
		(SituadoEn oscar z2)
		(SituadoEn rosa z3)
		(SituadoEn algoritmo z4)
		...
		(SituadoEn dicaprio z11)
		(SituadoEn princesa z12)
		(SituadoEn principe z13)
		(SituadoEn bruja z14)
		(SituadoEn profesor z15)
